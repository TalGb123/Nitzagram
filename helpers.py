...
def draw_comment_text_box():
    pygame.draw.rect(screen, GREY, pygame.Rect(
        VIEW_MORE_COMMENTS_X_POS, VIEW_MORE_COMMENTS_Y_POS, 235, 20))
    pygame.draw.rect(screen, WHITE,
                     pygame.Rect(VIEW_MORE_COMMENTS_X_POS + 1,
                                 VIEW_MORE_COMMENTS_Y_POS + 1, 233, 18))
    pygame.display.flip()
    ...
    while not pressed_enter:
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                ...
                font2 = pygame.font.SysFont('chalkduster.ttf', int(UI_FONT_SIZE), bold=False)
